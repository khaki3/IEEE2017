...
__global__ void __kernel___forma_kernel__0__(float * __restrict__ input, int N, int M, int FORMA_BLOCKDIM_X, int FORMA_BLOCKDIM_Y, float * __restrict__ __var_1__){
  ...
  for (int __iter_1__ = FORMA_MAX(0,__iter_y__-4); __iter_1__ <= __iter_y__+3; __iter_1__++) {
	...
	// Bottom
        float __temp_2__ = (__tilevar_2__[__iter_3__-1-__iter_0__]);
        float __temp_5__ = (__tilevar_2__[__iter_3__-__iter_0__]);
        float __temp_6__ = (7 * __temp_2__ + 5 * __temp_5__);
        float __temp_9__ = (__tilevar_2__[__iter_3__+1-__iter_0__]);
        float __temp_10__ = (__temp_6__ + 9 * __temp_9__) / 118;
	t4 += __temp_10__;
	// Mid
        float __temp_13__ = (__tilevar_2__[__iter_3__-1-__iter_0__]);
        float __temp_17__ = (__tilevar_2__[__iter_3__-__iter_0__]);
        float __temp_18__ = (12 * __temp_13__ + 15 * __temp_17__);
        float __temp_21__ = (__tilevar_2__[__iter_3__+1-__iter_0__]);
        float __temp_22__ = (__temp_18__ + 12 * __temp_21__) / 118;
	b4 += __temp_22__;
	// Top
	...
	// Bottom
        float __temp_2__ = (__tilevar_3__[__iter_3__-1-__iter_0__]);
        float __temp_5__ = (__tilevar_3__[__iter_3__-__iter_0__]);
        float __temp_6__ = (7 * __temp_2__ + 5 * __temp_5__);
        float __temp_9__ = (__tilevar_3__[__iter_3__+1-__iter_0__]);
        float __temp_10__ = (__temp_6__ + 9 * __temp_9__) / 118;
	t5 += __temp_10__;
	// Mid
        float __temp_13__ = (__tilevar_3__[__iter_3__-1-__iter_0__]);
        float __temp_17__ = (__tilevar_3__[__iter_3__-__iter_0__]);
        float __temp_18__ = (12 * __temp_13__ + 15 * __temp_17__);
        float __temp_21__ = (__tilevar_3__[__iter_3__+1-__iter_0__]);
        float __temp_22__ = (__temp_18__ + 12 * __temp_21__) / 118;
	b5 += __temp_22__;
	// Top
