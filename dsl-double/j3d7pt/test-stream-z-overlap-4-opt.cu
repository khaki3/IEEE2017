...
__global__ void __kernel___forma_kernel__0__(double * __restrict__ input, int L, int M, int N, int FORMA_BLOCKDIM_X, int FORMA_BLOCKDIM_Y, int FORMA_BLOCKDIM_Z, double * __restrict__ __var_1__){
  ...
  for (int __iter_2__ = 1; __iter_2__ < L-1; __iter_2__++) {
    ...
    if(__iter_4__ >= FORMA_MAX((__iter_1__+1),1) & __iter_4__ <= FORMA_MIN(((__iter_1__+FORMA_BLOCKDIM_Y)-2),(M-2)) & __iter_5__ >= FORMA_MAX((__iter_0__+1),1) & __iter_5__ <= FORMA_MIN(((__iter_0__+FORMA_BLOCKDIM_X)-2),(N-2))) {
        double __temp_a3__ = (tilevar[0][__iter_5__+1-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-__iter_1__)]);
        double __temp_a7__ = (tilevar[0][__iter_5__-1-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-__iter_1__)]);
        double __temp_a8__ = (0.161f * __temp_a3__ + 0.162f * __temp_a7__);
        double __temp_a12__ = (tilevar[0][__iter_5__-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__+1-__iter_1__)]);
        double __temp_a13__ = (__temp_a8__ + 0.163f * __temp_a12__);
        double __temp_a17__ = (tilevar[0][__iter_5__-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-1-__iter_1__)]);
        double __temp_a18__ = (__temp_a13__ + 0.164f * __temp_a17__);
        double __temp_a23__ = (__temp_a18__ + 0.165f * t[0]);
        double __temp_a28__ = (__temp_a23__ + 0.166f * b[0]);
        double __temp_a32__ = (tilevar[0][__iter_5__-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-__iter_1__)]);
    ...
    if(__iter_4__ >= FORMA_MAX((__iter_1__+2),1) & __iter_4__ <= FORMA_MIN(((__iter_1__+FORMA_BLOCKDIM_Y)-3),(M-2)) & __iter_5__ >= FORMA_MAX((__iter_0__+2),1) &  __iter_5__ <= FORMA_MIN(((__iter_0__+FORMA_BLOCKDIM_X)-3),(N-2))) {
        double __temp_a50__ = (tilevar[1][__iter_5__+1-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-__iter_1__)]);
        double __temp_a54__ = (tilevar[1][__iter_5__-1-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-__iter_1__)]);
        double __temp_a55__ = (0.161f * __temp_a50__ + 0.162f * __temp_a54__);
        double __temp_a59__ = (tilevar[1][__iter_5__-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__+1-__iter_1__)]);
        double __temp_a60__ = (__temp_a55__ + 0.163f * __temp_a59__);
        double __temp_a64__ = (tilevar[1][__iter_5__-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-1-__iter_1__)]);
        double __temp_a65__ = (__temp_a60__ + 0.164f * __temp_a64__);
        double __temp_a70__ = (__temp_a65__ + 0.165f * t[1]);
        double __temp_a75__ = (__temp_a70__ + 0.166f * b[1]);
        double __temp_a79__ = (tilevar[1][__iter_5__-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-__iter_1__)]);
    ...
    if(__iter_4__ >= FORMA_MAX((__iter_1__+3),1) & __iter_4__ <= FORMA_MIN(((__iter_1__+FORMA_BLOCKDIM_Y)-4),(M-2)) &  __iter_5__ >= FORMA_MAX((__iter_0__+3),1) & __iter_5__ <= FORMA_MIN(((__iter_0__+FORMA_BLOCKDIM_X)-4),(N-2))) {
        double __temp_a94__ = (tilevar[2][__iter_5__+1-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-__iter_1__)]);
        double __temp_a95__ = (tilevar[2][__iter_5__-1-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-__iter_1__)]);
        double __temp_a96__ = (0.161f * __temp_a94__ + 0.162f * __temp_a95__);
        double __temp_a97__ = (tilevar[2][__iter_5__-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__+1-__iter_1__)]);
        double __temp_a98__ = (__temp_a96__ + 0.163f * __temp_a97__);
        double __temp_a99__ = (tilevar[2][__iter_5__-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-1-__iter_1__)]);
        double __temp_a100__ = (__temp_a98__ + 0.164f * __temp_a99__);
        double __temp_a102__ = (__temp_a100__ + 0.165f * t[2]);
        double __temp_a104__ = (__temp_a102__ + 0.166f * b[2]);
        double __temp_a105__ = (tilevar[2][__iter_5__-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-__iter_1__)]);
        double __temp_a106__ = (__temp_a104__ - 1.670f * __temp_a105__);
    ...
    if(__iter_4__ >= FORMA_MAX((__iter_1__+4),1) & __iter_4__ <= FORMA_MIN(((__iter_1__+FORMA_BLOCKDIM_Y)-5),(M-2)) & __iter_5__ >= FORMA_MAX((__iter_0__+4),1) & __iter_5__ <= FORMA_MIN(((__iter_0__+FORMA_BLOCKDIM_X)-5),(N-2))) {
        double __temp_a120__ = (tilevar[3][__iter_5__+1-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-__iter_1__)]);
        double __temp_a121__ = (tilevar[3][__iter_5__-1-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-__iter_1__)]);
        double __temp_a122__ = (0.161f * __temp_a120__ + 0.162f * __temp_a121__);
        double __temp_a123__ = (tilevar[3][__iter_5__-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__+1-__iter_1__)]);
        double __temp_a124__ = (__temp_a122__ + 0.163f * __temp_a123__);
        double __temp_a125__ = (tilevar[3][__iter_5__-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-1-__iter_1__)]);
        double __temp_a126__ = (__temp_a124__ + 0.164f * __temp_a125__);
        double __temp_a128__ = (__temp_a126__ + 0.165f * t[3]);
        double __temp_a130__ = (__temp_a128__ + 0.166f * b[3]);
        double __temp_a131__ = (tilevar[3][__iter_5__-__iter_0__+FORMA_BLOCKDIM_X*(__iter_4__-__iter_1__)]);
        double __temp_a132__ = (__temp_a130__ - 1.670f * __temp_a131__);
